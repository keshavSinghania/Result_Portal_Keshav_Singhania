...
import { getNumberOfApprovedStudentsApi } from "../../axios";
import {
  FaUpload,
  FaUserCheck,
  FaUserCircle,
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {[
            { label: "Upload Result", icon: <FaUpload />, to: "/faculty/dashboard/upload-result" },
            { label: "Approve Students", icon: <FaUserCheck />, to: "/faculty/dashboard/approve-students" },
            { label: "Manage Students", icon: <FaUserEdit />, to: "/faculty/dashboard/delete-student" },
            { label: "Profile", icon: <FaUserCircle />, to: "/faculty/dashboard/profile" },
          ].map((action) => (
            <a
              key={action.label}
              href={action.to}
            ...
            >
              <div className="text-3xl mb-2 text-purple-600">{action.icon}</div>
